...
struct winrt::Windows::UI::Color col = Colors::Green();
...
void winrt::MyPen::implementation::MainWindow::CanvasControl_Draw(winrt::Microsoft::Graphics::Canvas::UI::Xaml::CanvasControl const& sender, winrt::Microsoft::Graphics::Canvas::UI::Xaml::CanvasDrawEventArgs const& args)
{
    ...
    for (int i = 1; i < n; i++) {
        ...
        args.DrawingSession().DrawLine(vx[i - 1], vy[i - 1], vx[i], vy[i], col, 8);
    }
...
void winrt::MyPen::implementation::MainWindow::Button_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
        col = Colors::Black();
}
